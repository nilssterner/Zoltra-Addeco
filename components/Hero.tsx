    ...
    <section className="relative bg-white border-b border-slate-100">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-20 sm:py-28 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mb-4">
          <a
            href="#app"
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-slate-900 text-white font-semibold text-sm hover:bg-slate-800 transition-colors shadow-sm"
          >
